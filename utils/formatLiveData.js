...
function formatLiveData(row) {
  ...
  const data = {
    ...
    evcc1_evse_stat:              toNumber(r.evcc1_evse_stat),
    evcc1_evse_chg_finished:      toNumber(r.evcc1_evse_chg_finished),
    evcc1_evse_processing:        toNumber(r.evcc1_evse_processing),
    evcc1_evse_isol_stat:         toNumber(r.evcc1_evse_isol_stat),
    evcc1_evse_transfer_type:     toNumber(r.evcc1_evse_transfer_type),
    evcc1_evse_notification:      toNumber(r.evcc1_evse_notification),
    evcc1_evse_pwr_delivery:      toNumber(r.evcc1_evse_pwr_delivery),
    evcc1_chg_finished:           toNumber(r.evcc1_chg_finished),
    evcc1_cp_stat:                toNumber(r.evcc1_cp_stat),
    evcc1_s2_on_stat:             toNumber(r.evcc1_s2_on_stat),
    evcc1_pd_stat:                toNumber(r.evcc1_pd_stat),
    evcc1_duty_value:             toNumber(r.evcc1_duty_value),
    evcc1_lock_stat:              toNumber(r.evcc1_lock_stat),
    evcc1_aag_value:              toNumber(r.evcc1_aag_value),
    evcc1_error_code:             toNumber(r.evcc1_error_code),
    evcc1_step_num:               toNumber(r.evcc1_step_num),
    evcc1_evse_max_delay_s:       toNumber(r.evcc1_evse_max_delay_s),
    evcc1_evse_max_volt_v:        toNumber(r.evcc1_evse_max_volt_v),
    evcc1_evse_max_curr_a:        toNumber(r.evcc1_evse_max_curr_a),
    evcc1_evse_out_volt_v:        toNumber(r.evcc1_evse_out_volt_v),
    evcc1_evse_out_curr_a:        toNumber(r.evcc1_evse_out_curr_a),
    evcc1_evse_min_volt_v:        toNumber(r.evcc1_evse_min_volt_v),
    evcc1_evse_min_curr_a:        toNumber(r.evcc1_evse_min_curr_a),
    evcc1_evse_max_pwr_w:         toNumber(r.evcc1_evse_max_pwr_w),
    evcc1_lock_status:            toNumber(r.evcc1_lock_status),
    evcc1_lock_alarm:             toNumber(r.evcc1_lock_alarm),
    evcc1_dcac_chg_mode:          toNumber(r.evcc1_dcac_chg_mode),
    evcc1_evse_evcc_chg_finished: toNumber(r.evcc1_evse_evcc_chg_finished),
    evcc1_ac_max_current_value_a: toNumber(r.evcc1_ac_max_current_value_a),
